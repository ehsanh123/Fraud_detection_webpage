...
import "../../components/model_page/fomatcss.css";
import SelectPart from "../../components/model_page/select";
import DatesPart from "@/app/components/model_page/datapart";
...
//     <div className="form-container">
//       <h1>Fraud Detection</h1>
//       <form action="/pages/submit" method="POST">
//         <label htmlFor="USER_ID">USER_ID:</label>
//         <input
//           type="text"
//           id="USER_ID"
//           name="USER_ID"
//           defaultValue="2416fa3c-0085-4d39-b2a8-e750506aa46f"
//           disabled
//         />
