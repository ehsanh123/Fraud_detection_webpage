...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  if (req.method === 'POST') {
    ...
    const args: string[] = ['arg1','arg2']//formData  // Replace with actual arguments to pass
    //with out explicitly telling where to go for python, it will go to a default location
